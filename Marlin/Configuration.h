 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -39, -12, -1.640 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 38, 38, 38, 38 } // (mm) Left, Front, Right, Back insets
